  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="modServiceSchedLabel">Set Services' Schedule</h1>
      ...
      <div class="modal-body">
        ...
        <div class="input-group mb-3">
          <!-- mon start time -->
          <span class="input-group-text bg-warning text-black w-25">Monday</span>
        ...
        <div class="input-group mb-3">
          <!-- wed start time -->
          <span class="input-group-text bg-warning text-black w-25">Wednesday</span>
        ...
        <div class="input-group mb-3">
          <!-- fri start time -->
          <span class="input-group-text bg-warning text-black w-25">Friday</span>
