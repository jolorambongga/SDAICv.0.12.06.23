      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          response.data_doctor.forEach(function(data) {
            ...
            <button id='callEdit' type='button' class='btn btn-success btn-sm' data-bs-toggle='modal' data-bs-target='#mod_editDoc'>Edit</button>
            <button id='callDelete' type='button' class='btn btn-danger btn-sm' data-bs-toggle='modal' data-bs-target='#mod_delDoc'>Delete</button>
            </div>
            </td>
            </tr>
            `;
